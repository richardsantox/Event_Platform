...
export type CreatedSubscribeMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreatedSubscribeMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreatedSubscribeDocument = gql`
    mutation CreatedSubscribe($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CreatedSubscribeMutationFn = Apollo.MutationFunction<CreatedSubscribeMutation, CreatedSubscribeMutationVariables>;

/**
 * __useCreatedSubscribeMutation__
 *
 * To run a mutation, you first call `useCreatedSubscribeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreatedSubscribeMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createdSubscribeMutation, { data, loading, error }] = useCreatedSubscribeMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreatedSubscribeMutation(baseOptions?: Apollo.MutationHookOptions<CreatedSubscribeMutation, CreatedSubscribeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreatedSubscribeMutation, CreatedSubscribeMutationVariables>(CreatedSubscribeDocument, options);
      }
export type CreatedSubscribeMutationHookResult = ReturnType<typeof useCreatedSubscribeMutation>;
export type CreatedSubscribeMutationResult = Apollo.MutationResult<CreatedSubscribeMutation>;
export type CreatedSubscribeMutationOptions = Apollo.BaseMutationOptions<CreatedSubscribeMutation, CreatedSubscribeMutationVariables>;
